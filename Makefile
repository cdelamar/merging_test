...
#    Updated: 2024/10/03 01:58:52 by cdelamar         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
EXECUTING_FILES = command pipe_command main_exec exec memory path signal redirection heredoc fd basic_exec pipe_exec safety
